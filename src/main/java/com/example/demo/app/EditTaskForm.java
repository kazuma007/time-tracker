...
public class EditTaskForm {
	...
	public EditTaskForm(String taskName, double expectedManPower, double actualManPower, String startDate,
	...
	public String toString() {
		return "EditTaskForm [taskName=" + taskName + ", expectedManPower=" + expectedManPower + ", actualManPower="
